...
const char module_name[32] = "Molex 504070 Module";
...
const uint8_t channel_map[32] = {
    55, 87, 54, 86, 53, 85, 52, 84,
    51, 83, 50, 82, 49, 81, 48, 80,
    47, 79, 46, 78, 45, 77, 44, 76,
    43, 75, 42, 74, 41, 73, 40, 72
};

const map_config_t maps[] = {
    {"ONIX Neuropix-2.0/Biosig.", 32, channel_map}
};
